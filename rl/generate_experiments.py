...
from envs import LunarLander, Breakout
...
def generate_experiments():
    ...
    custom_experiment = Experiment(
        ...
        pruner = make_pruner(rewind_epoch=0, rescale=None, pruner_constructor=GlobalPruner, reinit_to_random=True),
    )
    ...
    for repeat in range(4):
        ...
        exp.logname = "ReinitToRandom_repeat_{}". \
            format(repeat)
